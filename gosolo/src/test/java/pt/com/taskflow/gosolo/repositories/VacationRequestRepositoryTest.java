...
class VacationRequestRepositoryTest {
    ...
    void existsOverlappingActiveVacation_trueWhenPendingOverlaps() {
        persistVacation(collaboratorA, LocalDate.of(2026, 6, 1), LocalDate.of(2026, 6, 10), VacationStatus.PENDING);
        em.flush();
    ...
    void existsOverlappingActiveVacation_trueWhenApprovedOverlaps() {
        persistVacation(collaboratorA, LocalDate.of(2026, 6, 1), LocalDate.of(2026, 6, 10), VacationStatus.APPROVED);
        em.flush();
    ...
    void existsOverlappingActiveVacation_falseWhenRejectedInSamePeriod() {
        ...
        persistVacation(collaboratorA, LocalDate.of(2026, 6, 1), LocalDate.of(2026, 6, 10), VacationStatus.REJECTED);
        em.flush();
    ...
    void existsOverlappingActiveVacation_falseWhenOtherUserOverlaps() {
        ...
        persistVacation(collaboratorB, LocalDate.of(2026, 6, 1), LocalDate.of(2026, 6, 10), VacationStatus.PENDING);
        em.flush();
    ...
    void existsOverlappingActiveVacation_trueWhenAdjacentDatesOverlap() {
        // o dia final do pedido existente é igual ao dia inicial do novo — conta como sobreposição
        persistVacation(collaboratorA, LocalDate.of(2026, 6, 1), LocalDate.of(2026, 6, 10), VacationStatus.PENDING);
        em.flush();
    ...
    // -------------------------------------------------------------------------
    // findByUserManagerIdOrUserId — manager vê as suas ferias + as dos seus colaboradores
    // -------------------------------------------------------------------------
